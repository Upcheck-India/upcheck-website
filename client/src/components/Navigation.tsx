          ...
          >
            <DropdownMenu open={exploreHover.isOpen} modal={false} onOpenChange={(open) => { if (!open) exploreHover.onMouseLeave(); }}>
              ...
              >
                ...
                <DropdownMenuItem asChild className="cursor-pointer rounded-xl px-3 py-2 text-sm font-medium text-slate-800 dark:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-[#0067B1] focus:bg-slate-100 focus:text-[#0067B1] transition-colors">
                  <Link href="/technology" className="w-full text-inherit">Technology</Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild className="cursor-pointer rounded-xl px-3 py-2 text-sm font-medium text-slate-800 dark:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-[#0067B1] focus:bg-slate-100 focus:text-[#0067B1] transition-colors">
                  <Link href="/pricing" className="w-full text-inherit">Pricing</Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild className="cursor-pointer rounded-xl px-3 py-2 text-sm font-medium text-slate-800 dark:text-slate-100 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-[#0067B1] focus:bg-slate-100 focus:text-[#0067B1] transition-colors">
                  <Link href="/welfare" className="w-full text-inherit">Welfare</Link>
                </DropdownMenuItem>
                  ...
                  <div className="flex flex-col">
                    ...
                    {mobileExpanded === 'explore' && (
                      ...
                      >
                        ...
                        <Link href="/pricing" onClick={() => setMobileMenuOpen(false)} className="py-2 text-sm text-muted-foreground">{t("nav.pricing", "Pricing")}</Link>
                        <Link href="/welfare" onClick={() => setMobileMenuOpen(false)} className="py-2 text-sm text-muted-foreground">{t("nav.welfare", "Welfare")}</Link>
